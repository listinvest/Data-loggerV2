...
const uint32_t LOG_INTERVAL_USEC = 1250;    //currently 1250 is MAX (= 800 Hz)
//------------------------------------------------------------------------------
...
int state = HIGH;  //LED is high to start
...
//------------------------------------------------------------------------------
void testSensor() {
  const uint32_t interval = 20000; //test speed in mS
  int32_t diff;
  data_t data;
